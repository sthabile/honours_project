...
PureAodvRouting::SetUp(/*int argc, char *argv[]*/)
{
  ...
  simulateAttack = false;  //false by default
}
...
// Installing an application at the source node
    ...
    apps.Stop(Seconds(simulationTime)); //TODO: Leave extra time for queueing packet to be processed
...
// Tracing using Anim
    ...
    AnimationInterface anim ("blackhole_animation.xml"); // Mandatory
...
//More Flowmon tracing
    ...
    flwMon -> SerializeToXmlFile("blackhole_aodvflow.xml",true,false);
