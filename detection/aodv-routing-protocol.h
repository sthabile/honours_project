...
//============================================================================================
//            BLACKHOLE ATTACK DETECTION METHODS
//============================================================================================
/**
 * Set the enableBlackholeAttackDetection flag
 * \param f 
 */

  void setDetectionFlag(bool f) 
  { 
    enableBlackholeAttackDetection = f;
  }                         

/**
 * Get the enableBlackholeAttackDetection flag
 */
  bool getDetectionFlag () const
  { 
    return enableBlackholeAttackDetection;
  } 

/**
 * Set the dstSeqNoThreshold value
 * \param f 
 */

  void setDstSeqThreshold(int32_t threshold) 
  { 
    dstSeqNoThreshold = threshold;
  }                         

/**
 * Get the dstSeqNoThreshold value
 */
  int32_t getDstSeqThreshold () const
  { 
    return dstSeqNoThreshold;
  } 
...
//============================================================================================
//             BLACKHOLE ATTACK DETECTION VARIABLES
//============================================================================================
/**
 * enableBlackholeAttackDetection is used to indicate whether blackhole attack detection should 
 * be done by the node
 */
  bool enableBlackholeAttackDetection;

  int32_t dstSeqNoThreshold;  

    // Map for all the RREP packets arriving at the source node
  // Maps the RREP packets to a destination address
  static std::map< uint32_t , list<StoredRrep> > m_receivedReplies;
  //\}
...
private:
   ...
   */
  void RecvReplyDetection (Ptr<Packet> p, uint32_t dstSeqNo, uint32_t seqNumthreshold,Ipv4Address rrepOrigin,Ipv4Address rrepDst ,Ipv4Address my, Ipv4Address src, Ptr<NetDevice> dvc,Ipv4InterfaceAddress intfAddrss);
  /**
   * Receive RREP_ACK
   * \param neighbor neighbor address
   */
